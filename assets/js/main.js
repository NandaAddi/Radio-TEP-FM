...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const closeBtn = document.querySelector(".dismiss");

    // Fungsi untuk menutup popup dan memutar audio
    function closePopup() {
        ...
        // Coba mainkan audio saat tombol ditekan
        const playPromise = audio.play();
        if (playPromise !== undefined) {
            playPromise
                .then(() => {
                    console.log("Audio berhasil diputar setelah klik tombol CLOSE.");
                })
                .catch((error) => {
